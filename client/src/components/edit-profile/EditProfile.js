...
class EditProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      // Bring skill array to back to CSV
  ...
  render() {
    ...
    // Select options sfor status
    const options = [
      {
        label: "* Select professionnal Status",
        value: "0"
      },
      {
        label: "Developper",
      ...
      {
        label: "Junior Developper",
        value: "Junior Developper"
      },
      {
        label: "Senior Developper",
        value: "Senior Developper"
      },
      {
        label: "Manager",
        value: "Manager"
